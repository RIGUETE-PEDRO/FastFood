...
<?php if(!empty($toastMessages)): ?>
    <div id="ff-toast-stack" class="ff-toast-stack" aria-live="polite" aria-atomic="true">
        <?php $__currentLoopData = $toastMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="ff-toast ff-toast--<?php echo e($toast['type']); ?>" data-timeout="5000" role="status">
                <div class="ff-toast__content"><?php echo e($toast['text']); ?></div>
...
<?php endif; ?>
<?php /**PATH C:\Users\omega\Downloads\TCC\FlashFood\resources\views/components/flash-toast.blade.php ENDPATH**/ ?>