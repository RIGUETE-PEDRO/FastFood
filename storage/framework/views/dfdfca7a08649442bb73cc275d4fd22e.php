...
<body>
    ...
    <main>
        ...
        <div class="container-produtos mt-4">
            ...
            <div class="produto produto--interactive" data-produto-id="<?php echo e($pizza->id); ?>" data-produto-nome="<?php echo e($pizza->nome); ?>" data-produto-preco="<?php echo e($pizza->preco); ?>">
                <div class="container-img">
                    <img src="<?php echo e(asset('img/produtos/' . $pizza->imagem_url)); ?>" alt="<?php echo e($pizza->nome); ?>" loading="lazy">
                    <span class="produto-badge" aria-label="Preço">R$ <?php echo e(number_format((float) $pizza->preco, 2, ',', '.')); ?></span>
                </div>
                <div class="preco-conteiner">
                    <label class="lanche"><?php echo e($pizza->nome); ?></label>
                </div>
                <?php if(!empty($pizza->descricao)): ?>
                <div class="ingredientes-wrap">
                    <span class="ingredientes">ingredientes:</span>
                    <div class="ingredientes-lista"><?php echo e($pizza->descricao); ?></div>
                </div>
                <?php else: ?>
                <br>
                <br>
...
<?php /**PATH C:\Users\omega\Downloads\TCC\FlashFood\resources\views/Pizza.blade.php ENDPATH**/ ?>