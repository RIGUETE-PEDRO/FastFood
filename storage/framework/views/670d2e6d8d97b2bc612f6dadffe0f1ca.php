...
<nav class="ff-sidebar d-flex flex-column" aria-label="Menu principal">
    ...
    <?php if($isAdmin): ?>
        <ul class="nav nav-pills flex-column mb-auto ff-sidebar__nav">
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'DASHBORD')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('Administrativo', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Administrativo') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('dashboard'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'GERENCIAMENTO_FUNCIONARIOS')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('gerenciamento_funcionarios', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('gerenciamento_funcionarios') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('users'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'PEDIDOS')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('Pedidos_Administrativo', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Pedidos_Administrativo') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('orders'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'GERENCIAMENTO_PRODUTOS')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('gerenciamento_produtos', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('gerenciamento_produtos') || request()->routeIs('gerenciamento_Produtos') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('products'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'ENTREGAS')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('entregas', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('entregas') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('delivery'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'MESAS')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('mesas.index', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('mesas.*') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('tables'); ?>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'GARCOM')): ?>
                <li class="nav-item">
                    <a href="<?php echo e(route('garcom', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('garcom') ? 'active' : ''); ?>">
                        <?php echo $ffIcon('garcom'); ?>
    ...
    <?php else: ?>
        <ul class="nav nav-pills flex-column mb-auto ff-sidebar__nav">
            <li class="nav-item">
                <a href="<?php echo e(route('home', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('home'); ?>

                    <span>Principal</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('Lanches', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Lanches') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('lanches'); ?>

                    <span>Lanches</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('Pizza', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Pizza') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('pizza'); ?>

                    <span>Pizzas</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('Porcao', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Porcao') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('porcao'); ?>

                    <span>Porcao</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('Bebidas', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('Bebidas') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('bebidas'); ?>

                    <span>Bebidas</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('pedidos', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('pedidos') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('orders'); ?>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('carrinho', [], false)); ?>" class="nav-link <?php echo e(request()->routeIs('carrinho') ? 'active' : ''); ?>">
                    <?php echo $ffIcon('cart'); ?>
        ...
        <?php if(isset($usuario) && $usuario): ?>
            <div class="dropdown w-100">
                    ...
                    <div class="d-flex align-items-center me-2">
                        <div class="circulo_maior me-2">
                            <img class="profile-image" id="preview-image"
                                src="<?php echo e(isset($usuario['url_imagem_perfil']) && $usuario['url_imagem_perfil'] ? asset('img/perfil/' . $usuario['url_imagem_perfil']) : (isset($usuario->url_imagem_perfil) && $usuario->url_imagem_perfil ? asset('img/perfil/' . $usuario->url_imagem_perfil) : asset('img/perfil/personPadrao.svg'))); ?>"
                                alt="Foto do usuario">
                        </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end list w-100">
                    <li><a class="dropdown-item text" href="<?php echo e(route('perfil', [], false)); ?>">Editar perfil</a></li>
                    <?php if($canSeeConfiguracoes): ?>
                        <li><a class="dropdown-item text" href="<?php echo e(route('admin.configuracoes', [], false)); ?>">Configuracoes</a></li>
                    <?php endif; ?>
                    <li>
