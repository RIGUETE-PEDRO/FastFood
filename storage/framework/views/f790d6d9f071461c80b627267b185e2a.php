...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/Admin/GerenciamentoProduto.css')); ?>">
</head>
...
<body>
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <img src="<?php echo e(asset('img/produtos/' . $produto->imagem_url)); ?>" alt="Imagem do produto" style="width:48px; height:48px; object-fit:cover; border-radius:8px;">
                                    <?php else: ?>
                                    <span style="color:#aaa;">Sem imagem</span>
                                    <?php endif; ?>
                                </td>
                                <td class="nome-cell"><?php echo e($produto->nome); ?></td>
                                <td>R$ <?php echo e(number_format($produto->preco, 2, ',', '.')); ?></td>
                                <td>
                                    <span class="badge <?php echo e($produto->disponivel ? 'bg-success' : 'bg-danger'); ?>">
                                        <?php echo e($produto->disponivel ? 'Ativo' : 'Inativo'); ?>
                                ...
                                <td>
                                    <label class="toggle-switch">
                                        <input type="checkbox" class="toggle-carrousel"
                                               data-produto-id="<?php echo e($produto->id); ?>"
                                               data-url="<?php echo e(route('produtos.carrousel.toggle', $produto->id)); ?>"
                                               <?php echo e(isset($produto->no_carrousel) && $produto->no_carrousel ? 'checked' : ''); ?>>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="btn-action btn-edit"
                                            ...
                                            data-categoria-id="<?php echo e($produto->categoria_id); ?>"
                                            data-ativo="<?php echo e($produto->disponivel ? 1 : 0); ?>"
                                            data-imagem-url="<?php echo e($produto->imagem_url); ?>"
                                            data-action="<?php echo e(route('produtos.atualizar', $produto->id)); ?>"
                                        ...
                                        <button class="btn-action btn-delete"
                                            ...
                                            data-nome="<?php echo e($produto->nome); ?>"
                                            data-produto-id="<?php echo e($produto->id); ?>"
                                            data-usuario-id="<?php echo e($usuario->usuario_id ?? $usuario->id); ?>"
                                            data-action="<?php echo e(route('deletar_produto', $produto->id)); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    ...
    <!-- Overlay de cadastro/edição de produto -->
        <div class="overlay-backdrop" id="createProductOverlay">
            <div class="overlay-panel">
                ...
                <form id="formCreateProduct" action="<?php echo e(route('Cadastrar_Produto')); ?>" method="POST" enctype="multipart/form-data" data-cadastro-action="<?php echo e(route('Cadastrar_Produto')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('js/gerenciamento-produto.js')); ?>"></script>
    <script src="<?php echo e(asset('js/gerenciamento-funcionario.js')); ?>"></script>
        </div>
    </div>
</body>

</html>
<?php /**PATH C:\Users\omega\Downloads\TCC\FlashFood\resources\views/Admin/GerenciamentoProduto.blade.php ENDPATH**/ ?>