            ...
            <aside class="profile-card__summary">
                <div class="profile-avatar">
                    <div class="profile-image-wrapper">
                        <img class="profile-image" id="preview-image" src="{{ $usuario->url_imagem_perfil ? asset('img/perfil/' . $usuario->url_imagem_perfil) : asset('img/perfil/personPadrao.svg') }}" alt="Foto do usuário">
